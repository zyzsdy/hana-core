import newBC, { BC } from './bc'
import { TERM_CHAR, ROOT_ID, TERM_CODE } from './genericparameters';
import { stringToUtf8Bytes } from './stringutil';
import UKeys, {Keys} from './keysinterface';
...
export default class DoubleArrayBuilder{
     ...
     */
    append(key: Uint8Array, record: number) {
     ...
     *
     * @param {Keys[]} keys Array of keys. A key is a Object which has properties 'k', 'v'.
     * 'k' is a key string, 'v' is a record assigned to that key.
     * @return {DoubleArray} Compiled double array
     */
    build(keys: Keys[], sorted: boolean = false): DoubleArray {
        var buff_keys: UKeys[];
